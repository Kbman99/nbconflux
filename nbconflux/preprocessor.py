...
class ConfluencePreprocessor(Preprocessor):
    ...
    def preprocess(self, nb, resources):
        ...
        while path:
            ...
            resp = requests.get(url, auth=(self.exporter.username, self.exporter.password) if self.export.username and self.exporter.password else None, cookies=self.exporter.cookies)
